    ...
    <div class="row justify-content-center mt-5">
        <div class="col-9 col-md-6 mt-5">
            ...
            <form method="POST" action="{{ route('mypage') }}">
                ...
                <div class="form-group">
                    <div class="d-flex justify-content-between">
                        <label for="phone" class="text-md-left negoyameshi-edit-user-info-label">電話番号</label>
                    </div>
                    <div class="collapse show editUserPhone">
                ...
                <hr>
                <button type="submit" class="btn nagoyameshi-submit-button mt-3">
                    保存
                </button>
            </form>
            ...
            <hr>
             <div class="d-flex justify-content-start">
                 <form method="POST" action="{{ route('mypage.destroy') }}">
                     ...
                     <div class="btn btn-danger dashboard-delete-link" data-bs-toggle="modal" data-bs-target="#delete-user-confirm-modal">退会する</div>
